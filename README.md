...
- Created an Actions workflow to lint our Markdown files.
- You caught an issue in a file and fixed the issue before it could make it to `main`.
- Learned how to use build artifacts for test reports.
- Enabled branch protections to require the workflow to pass before merging.
